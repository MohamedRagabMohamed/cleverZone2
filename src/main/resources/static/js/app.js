...
var app = angular.module("CleverZone",
		[ 'ngCookies', 'ngRoute', 'ui.bootstrap' ]);
...
app.controller('CourseController', [ "$scope", "$location", "$http",
		"$cookieStore", "CommonService",
		function($scope, $location, $http, $cookieStore, CommonService) {
...
app.controller('CourseGetter', [ "$scope", "$http", "CommonService",
